...
(function() {
  var Game, Player, Thing, UUID, V, b2d, box_body_def, box_fixture_def, box_shape_def, box_size, frame_rate, gravity, players, things, _;
  ...
  Game = (function() {
    ...
    function Game(_arg, id) {
      ...
      update = function() {
        var changes, player, thing, _ref, _ref1, _results;
        _ref = _this.players;
        for (id in _ref) {
          player = _ref[id];
          player.control();
        ...
        for (id in _ref1) {
          player = _ref1[id];
          _results.push(player.user.socket.volatile.emit('update', changes));
        }
        return _results;
      };
