...
(function() {
  ...
  module.factory('networking', function($rootScope) {
    ...
    Thing = (function() {
      ...
      Thing.prototype.make_node = function() {
        var node;
    ...
    Player = (function(_super) {
      ...
      Player.prototype.make_node = function() {
        var node;
        return node = $("<div class=\"bound-players\">\n    <div class=\"player1 shape\"></div>\n    <div class=\"player2 shape\"></div>\n    <div class=\"rope\"></div>\n</div>");
      };
    ...
    Arena = (function(_super) {
      ...
      Arena.prototype.make_node = function() {
        return this.node = $('<div class="arena"></div>');
      };
