...
(function() {
  var Challenge, Game, Player, Thing, UUID, User, V, app, b2d, box_body_def, box_fixture_def, box_shape_def, box_size, challenges, express, frame_rate, games, gravity, http, io, json_response, players, port, server, socket_io, speed, things, update, users, world, _;
  ...
  Game = (function() {
    ...
    function Game(_arg, id) {
      this.challenger = _arg.challenger, this.challengee = _arg.challengee;
      this.id = id != null ? id : UUID();
      games[this.id] = this;
    }
  ...
  io.sockets.on('connection', function(socket) {
    ...
    return socket.on('accept_challenge', function(challenge_id) {
      var challenge;
      challenge = challenges[challenge_id];
      return new Game(challenge);
    });
    /*
