...
(function() {
  var BasicGame, Challenge, DefaultGame, SpinBashersGame, UUID, User, add_to_chat_history, app, challenges, chat_history, express, games, http, io, json_response, max_chat_history_length, port, server, socket_io, users, _;
