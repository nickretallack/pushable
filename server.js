...
(function() {
  var Faye, Player, Thing, UUID, V, app, b2d, box2d_interval, box_body_def, box_fixture_def, box_shape_def, box_size, express, faye, faye_client, faye_keyboard, frame_rate, frames_per_second, get_player, gravity, interval, players, port, speed, things, update, world;
